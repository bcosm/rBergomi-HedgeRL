...
| Metric | RL Agent (Avg Across Seeds) | Classical Delta-Hedge | Improvement |
|:---|:---:|:---:|:---:|
...
| Metric | RL Agent (Avg Across Seeds) | Delta Hedge | RL Advantage (%) |
|:---|:---:|:---:|:---:|
| **Annual Volatility (%)** | 0.35 | 0.46 | 23.8 |
| **Max Drawdown (%)** | -0.85 | -1.33 | -36.3 |
